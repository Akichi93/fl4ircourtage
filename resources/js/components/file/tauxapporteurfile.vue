<template>
  <div class="tab-pane fade" id="taux_apporteurs">
    <div class="row">
        ...
        <div class="card profile-box flex-fill">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="file" ref="fileInput" @change="handleFileChange" accept=".csv" required />
            </div>
...
export default {
  ...
  methods: {
    ...
    uploadFile() {
      ...
      axios.post('/api/auth/importauxapporteur', formData, {
        headers,
