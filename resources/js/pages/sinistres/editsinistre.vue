                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-top">
                            <li class="nav-item"><a class="nav-link active" href="#top-tab1" data-bs-toggle="tab">Voir le
                                    sinistre
                                    expires</a></li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <b-form-group id="type_contrat" label="Type de contrat:"
                                                                ...
                                                                <b-form-input id="type_contrat" v-model="form.type_contrat"
                                                                    type="text" placeholder="Type de contrat" required
                                                                    readonly="" :modelValue="form.type_contrat">
                                                                </b-form-input>
                                                                <b-form-input id="id_contrat" v-model="form.id_contrat"
                                                                    type="hidden" placeholder="Type de contrat" required
                                                                    :modelValue="form.id_contrat" style="display:none">
                                                                </b-form-input>
                                                            </b-form-group>

                                                            <b-form-group id="reference_compagnie"
                                                                label="Reference compagnie:" label-for="reference_compagnie"
                                                                description="">
                                                            ...
                                                            <b-form-group id="gestion_compagnie" label="Gestion compagnie:"
                                                            ...
                                                            <b-form-group id="numero_sinistre_agence"
                                                                ...
                                                                <b-form-input id="numero_sinistre_agence"
                                                                    v-model="form.numero_sinistre_agence" type="text"
                                                                    placeholder="Numéro sinistre agence">
                                                                </b-form-input>
                                                            </b-form-group>
                                                            <b-form-group id="garantie_applique" label="Garantie appliquée:"
                                                            ...
                                                            <b-form-group id="lieu" label="Lieu:" label-for="lieu"
                                                                description="">
                                                                <b-form-input id="lieu" v-model="form.lieu" type="text"
                                                                    placeholder="Lieu">
                                                                </b-form-input>
                                                            </b-form-group>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <b-form-group id="materiel_corporel"
                                                                        ...
                                                                        label-for="materiel_corporel" description="">
                                                                        <b-form-input id="materiel_corporel"
                                                                            v-model="form.materiel_corporel" type="text"
                                                                            placeholder="Materiel / corporel">
                                                                        </b-form-input>
                                                                    </b-form-group>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <b-form-group id="ipp" label="IPP:" label-for="ipp"
                                                                        description="">
                                                            ...
                                                            <b-form-group id="materiel_sinistre" label="Materiel sinistre:"
                                                        ...
                                                        <div class="col-md-6">
                                                            <b-form-group id="date_survenance" label="Date de survenance:"
                                                            ...
                                                            <b-form-group id="heure" label="Heure:" label-for="heure"
                                                                description="">
                                                                <b-form-input id="heure" v-model="form.heure" type="time"
                                                                    placeholder="Heure">
                                                                </b-form-input>
                                                            </b-form-group>


                                                            <b-form-group id="date_ouverture" label="Date de ouverture:"
                                                            ...
                                                            <b-form-group id="date_declaration" label="Date declaration:"
                                                            ...
                                                            <b-form-group id="date_declaration_compagnie"
                                                                ...
                                                                <b-form-input id="date_declaration_compagnie"
                                                                    v-model="form.date_declaration_compagnie" type="date"
                                                            ...
                                                            <b-form-group id="date_mission" label="Date de mission:"
                                                                ...
                                                                <b-form-input id="date_mission" v-model="form.date_mission"
                                                                    type="date" placeholder="Date de mission">
                                                                </b-form-input>
                                                            </b-form-group>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <b-form-group id="recours" label="Recours:"
                                                                        ...
                                                                        <b-form-input id="recours" v-model="form.recours"
                                                                            type="text" placeholder="Recours">
                                                                        </b-form-input>
                                                                    </b-form-group>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <b-form-group id="expert" label="Expert:"
                                                                        ...
                                                                        <b-form-input id="expert" v-model="form.expert"
                                                                            type="text" placeholder="Expert">
                                                                        </b-form-input>
                                                                    </b-form-group>
                                                                </div>
                                                            </div>
                                                            <b-form-group id="accident_adversaire"
                                                                label="Accident/Adversaire:" label-for="accident_adversaire"
                                                                description="">
                                            ...
                                            <div>
                                                <template v-for="file in files" :key="file.id_fichier" class="row">
                                                    ...
                                                    <iframe :src="'/images/piece_sinistres/' + file.nom_fichier"
                                                        frameborder="0" width="120" height="120" class="col-md-9"></iframe>

                                                    <a :href="'/images/piece_sinistres/' + file.nom_fichier"
                                                        class="btn btn-sm btn-warning col-md-3" target="_blank">Voir</a>
...
export default {
    ...
    methods: {
        ...
        updateSinistre(id) {
            this.form.put('/update/sinistre/' + id).then((response) => {
