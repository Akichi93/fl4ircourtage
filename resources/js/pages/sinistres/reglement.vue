<template>
    <div>
                                    ...
                                    <tbody>
                                        <template v-for="reglements_client in reglements_clients"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#editReglementss"
                                                                ...
                                                                <form>
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <input type="hidden" v-model="form.id_sinistre"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="number" class="form-control"
                                                                                ...
                                                                                :modelValue="form.montant" id="montant"
        ...
        <div class="modal fade" id="addReglement" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                    ...
                    <form>
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nom-field" class="form-control" placeholder="Nom ...." required=""
                                    v-model="form.nom">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" v-model="form.montant" id="montant" name="montant"
                                    placeholder="Montant">
                            </div>
                        </div>
                        <div class="modal-footer">
...
export default {
    ...
    methods: {
        ...
        addReglement() {
            this.form.post('/add/reglement').then((response) => {
                this.getReglement();
        ...
        updateReglement(id, client = "Beneficiaire") {
            let urlParams = new URLSearchParams(window.location.search);
            let sinistre = urlParams.get('sinistre');
            axios
                .get("/get/reglement?sinistre=" + sinistre + "&id=" + id + "&type=" + client)
                .then((response) => {
                    // this.loading = true;
                    // this.reglements_clients = response.data.reglements_client;
        ...
        updateReglementCompagnie(id, client = "Block") {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    // this.reglements_clients = response.data.reglements_client;
                    // this.form.referent = response.data.reglement.referent
                    console.log(response.data.reglement)
        ...
        changeReglement(id) {
            this.form.put("/change/reglement/" + id).then((response) => {
                this.getReglement();
        ...
        changeReglementCompagnie(id) {
            this.compagnieform.put("/api/change/reglement/" + id).then((response) => {
                this.getReglement();
