                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <Multiselect
                            @select="optionSelect"
                            v-model="contrats.apporteur_id"
                            :value="contrats.id_apporteur"
                            :options="apporteurs"
                            :custom-label="
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        let urlParams = new URLSearchParams(window.location.search);
        let myParam = urlParams.get("contrat");
        axios.all([axios.get("getViewContrat?contrat=" + myParam)]).then(
      ...
      editContrat() {
        axios
          .patch("/updateContrat/" + this.id_contrat, {
            //Contrat
