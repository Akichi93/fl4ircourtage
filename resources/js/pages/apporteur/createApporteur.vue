                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <p style="color: red" class="text-red" v-if="errors.code_postal" v-text="errors.code_postal[0]">
                          </p>
                        </div>
                      </div>
                      <div class="col-md-6">
                        ...
                        <div class="row">
                          <div class="col-md-9">
                            <div class="form-group">
                              <label>Adresse</label>
                              <Multiselect v-model="adresse_apporteur" :options="localisations" :custom-label="({ uuidLocalisation, nom_ville }) =>
...
export default {
  ...
  methods: {
    ...
    generateCodeApporteur() {
      ...
      let deuxPremiersCaracteres = this.nom_apporteur.substring(0, 2).toUpperCase();
