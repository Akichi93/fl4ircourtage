            ...
            <div class="row user-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom pt-3 pb-2">
                        <li class="nav-item"><a href="#emp_profile" data-bs-toggle="tab" class="nav-link active">Relance</a>
                        </li>
                        <li class="nav-item"><a href="#emp_projects" data-bs-toggle="tab" class="nav-link">Expiration dans 1
                                mois</a></li>
                        <li class="nav-item"><a href="#bank_statutory" data-bs-toggle="tab" class="nav-link">Expiration dans
                                2 mois</a></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end ico-sec d-flex justify-content-end">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#edit_department"
                                                    @click="getRelance(relance.id_relance)" title="Modifier"><i
                                                        class="fas fa-pen"></i>
                                                </a>
                                            </td>
                                        </tr>
                    ...
                    <div class="col-md-12">
                        <div>
                            <table class="table table-striped custom-table mb-0">
                                ...
                                <tbody>
                                    <template v-for="first in firsts" :key="first.id_contrat">
                                        <tr>
                                            <td v-text="first.numero_police"></td>
                                            <td v-text="first.nom_branche"></td>
                                            <td v-text="first.nom_compagnie"></td>
                                            <td v-text="first.nom_client"></td>
                                            <td v-text="first.prime_nette"></td>
                                            <td v-text="first.primes_ttc"></td>
                                            <td v-text="first.contact_client"></td>
                                ...
                                <tbody>
                                    <template v-for="second in seconds" :key="second.id_contrat">
                                        <tr>
                                            ...
                                            <td v-text="second.nom_compagnie"></td>
                                            <td v-text="second.nom_client"></td>
                                            <td v-text="second.prime_nette"></td>
                                            <td v-text="second.primes_ttc"></td>
                                            <td v-text="second.contact_client"></td>
...
export default {
    ...
    methods: {
        ...
        fetchTask() {
            var that = this;
            axios.all([axios.get("/getClient"), axios.get("/getRelance"), axios.get("/getOneExpiration"), axios.get("/getTwoExpiration")]).then(
