                ...
                <div class="row filter-row">
                    ...
                    <div class="col-md-4">
                        <div class="add-emp-section">
                            <router-link to="/createprospect" class="btn btn-success btn-add-emp" style="width: auto"> <i
                                    class="fas fa-plus"></i>Ajouter prospect</router-link>
                                    ...
                                    <template v-for="(prospect, index) in prospects.data" :key="index">
                                        <tr>
                                            ...
                                            <td class="text-end ico-sec d-flex justify-content-end">
                                                <a href="#" v-if="prospect.etat == 0"
                                                    @click="getProspect(prospect.id_prospect)" data-bs-toggle="modal"
                                                    data-bs-target="#delete_project" title="Admettre comme un client"><i
                                                        class="fas fa-check"></i>
                                                </a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#edit_department"
                                                    @click="getProspect(prospect.id_prospect)" title="Modifier"><i
                                                        class="fas fa-pen"></i>
                                                </a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#change_statut"
                                                    @click="getProspect(prospect.id_prospect)" title="Changer d'etat"><i
                                                        class="fas fa-edit"></i>
                                                </a>

                                                <a href="#" @click="viewprospect(prospect.id_prospect)"
                                                    title="Voir details"><i class="fas fa-eye"></i>
                                                </a>
                                                <a v-if="roles == 'ADMIN'" href="#" data-bs-toggle="modal"
...
export default {
    ...
    data() {
        return {
            ...
            etats: ["Recherche Saturation", "Etude en cours", "Client entier"],
        };
    },
    created() {
        this.getProspects();
