                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <Multiselect v-model="etat" :options="etats" placeholder="Choisir un etat"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="javascript:void(0);" data-bs-dismiss="modal"
                                    class="btn btn-primary continue-btn">Annuler</a>
                            </div>
                            <div class="col-6">
...
<!-- ChangeEtat() {
    axios
        .patch("/etatProspect/" + this.prospectoedit.id_prospect, {
            etat: this.etat,
        })
        .then((response) => {
            this.listprospect();
